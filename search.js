...
class MedievalSearch {
    ...
    loadSearchData() {
        ...
        this.searchData = [
            ...
            { type: 'persona', title: 'Pierre du Pont', url: 'personas/pierre-du-pont.html', keywords: 'french, knight, companion', period: 'Late Medieval' },
            { type: 'persona', title: 'Sir Michael', url: 'personas/sir-michael.html', keywords: 'knight, leader, company', period: 'Late Medieval' },
